...
import { FiPackage, FiClock, FiCheckCircle, FiTruck, FiAlertCircle, FiUser } from "react-icons/fi"
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-medium text-gray-900 mb-2">
              {filter === "all" ? "No tienes pedidos" : `No tienes pedidos ${getStatusText(filter).toLowerCase()}`}
            </h2>
            <p className="text-gray-500 mb-6">Cuando recibas pedidos, aparecerán aquí</p>
          </div>
        ) : (
                    ...
                    <tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="text-sm text-gray-900">Cliente #{order.buyer_id}</div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end space-x-3">
                          <Link href={`/seller/orders/${order.id}`} className="text-primary-600 hover:text-primary-900">
                            Ver detalles
                          </Link>
                          {order.status === "paid" && (
                            <button
